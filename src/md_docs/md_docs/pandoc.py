...
def extract_yaml(md_lines=None, **kwargs):
    ...
    A list of YAML blocks in the order they were discovered. Each block
    is simply a list of strings contained within the block markers.
    ...
    # Merge all the YAML blocks into one dictionary. NOTE: the values in
    # the last block, if duplicated in other blocks will overwrite
    # previous values
